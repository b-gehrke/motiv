...
public:
    ...
    public:
        Member(const otf2::chrono::duration &start,
               ...
               start(start), end(anEnd), location(std::move(location)) {}
    ...
    public:
        [[nodiscard]] const otf2::chrono::duration &getStart1() const {
            return start;
        }

        [[nodiscard]] const otf2::chrono::duration &getAnEnd() const {
            return end;
        }

        [[nodiscard]] const otf2::definition::location &getLocation1() const {
            return location;
        }
